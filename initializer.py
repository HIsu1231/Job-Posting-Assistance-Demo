...
def load_braincore4():
    st.session_state['company_introduction_text'] = """            주식회사 브레인코어는 인공지능(AI) 기반의 서비스 기획을 담당할 경력 3~5년의 서비스 기획자를 모집하고 있습니다. 
            이 직무는 AI 기술을 바탕으로 사용자 요구를 분석하고, 
            이를 반영한 서비스 구조 설계 및 기능 정의를 통해 고객 경험을 최적화하는 역할을 수행합니다. 
            서비스 기획자는 서비스 출시와 운영 과정에서 발생하는 문제를 해결하고, 
            다양한 이해관계자들과의 협업을 통해 프로젝트를 성공적으로 이끌어 나가게 됩니다. 
