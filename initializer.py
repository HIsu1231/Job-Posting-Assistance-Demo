...
def load_braincore2_kind():
    st.session_state['company_introduction_text'] = """            주식회사 브레인코어는 초·중등 학생들에게 인공지능(AI) 교육을 가르치고 함께 성장할 유능한 강사님을 찾고 있습니다. 
            ...
            교육 커리큘럼에 맞춰 수업 자료, 교재, 교구재를 준비하고, 학생들의 학습 수준에 맞춘 맞춤형 수업을 설계하며, 학습 성과에 대한 피드백도 제공해 주시게 됩니다. 
            ...
            저희가 제공하는 혜택으로는 교통비 지원, 수업에 필요한 교재 제공, 자율적인 수업 준비 시간, 그리고 교육 관련 세미나와 워크숍 참여 기회 등이 있습니다. 
